...
const Hero = () => {
  ...
  return (
    <section className="main w-screen overflow-hidden  h-screen flex flex-row items-start lg:pl-48 pl-10">
      <Swiper
        spaceBetween={30}
        centeredSlides={true}
        autoplay={{
      ...
      >
        {sliderData.map((slide) => {
          return (
            <SwiperSlide>
              <div className="flex flex-col lg:gap-y-4 gap-y-2 text-white ">
                <div className="w-full  flex flex-col gap-y-8 items-start">
                  <span className="lg:text-3xl text-lg font-[500]">
                    {slide.desc}
                  </span>
                  <h4>{slide.header}</h4>
                </div>
                <div className="flex flex-row items-center gap-x-6">
                  <button
                    ...
                    lg:ml-0 ml-8  bg-[#8092a8]
                     hover:bg-[#8092a8] hover:opacity-80
                      text-white px-10 rounded-md font-[600] 
                      text-sm  py-[0.8rem]"
                  >
                    BOOK NOW
                  </button>

                  <a  href="https://youtu.be/itLUM3ePkqQ" className="flex flex-row items-center gap-x-3 hover:text-gray-300 cursor-pointer">
                    <span className="font-Poppins">Watch Videos</span>
              ...
              <div className="lg:ml-24 w-96 h-96">
                  ...
                  <form className="w-64">
                    <div className="mb-4">
                      <div className={`relative ${fullname ? "mb-7" : "mb-4"}`}>
                        ...
                        <label
                          htmlFor="name"
                          className={`font-Poppins absolute left-2 transition-all ${
                            fullname ? "active" : "top-3 text-sm text-gray-400"
                          }`}
                        >
                          Full Name
                        </label>
                    ...
                    <div className="mb-4">
                      <div className={`relative ${email ? "mb-7" : "mb-4"}`}>
                        ...
                        <label
                          htmlFor="email"
                          className={`font-Poppins absolute left-2 transition-all ${
                            email ? "active" : "top-4 text-sm text-gray-400"
                          }`}
                        >
                          Email
                        </label>
